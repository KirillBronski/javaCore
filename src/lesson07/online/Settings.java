...
public class Settings extends JFrame {
    ...
    private static final String WIN_LENGTH_TEXT_PREFIX = "Выиграшная длина: ";
    ...
    private void addGameModeSettings(){
        add(new JLabel("Выберите ркжим игры"));
    ...
    private void addFieldSizeControl(){
        ...
        JLabel lbWinLength = new JLabel(WIN_LENGTH_TEXT_PREFIX + MAX_FIELD_LENGTH);
